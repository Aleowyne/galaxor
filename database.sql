...
INSERT INTO item(id, name, type, build_time, attack_point, defense_point, freight_capacity, img_filename) VALUES
  ('LABO', 'Laboratoire de recherche', 'STRUCTURE', '(50*2**$level)*(1-$tech_ia/100)**$usine_nani', '0', '0', '0', 'research_lab_structure.png'),
  ('CHANTIER', 'Chantier spatial', 'STRUCTURE', '(50*2**$level)*(1-$tech_ia/100)**$usine_nani', '0', '0', '0', 'space_construction_structure.png'),
  ('USINE_NANI', 'Usine de nanites', 'STRUCTURE', '(600*2**$level)*(1-$tech_ia/100)**$usine_nani', '0', '0', '0', 'nanite_factory_structure.png'),
  ('MINE', 'Mine de métal', 'STRUCTURE', '(10*2**$level)*(1-$tech_ia/100)**$usine_nani', '0', '0', '0', 'metal_mine_structure.png'),
  ('DEUTERIUM', 'Synthétiseur de deutérium', 'STRUCTURE', '(25*2**$level)*(1-$tech_ia/100)**$usine_nani', '0', '0', '0', 'deuterium_synthesizer_structure.png'),
  ('CENTR_SOL', 'Centrale solaire', 'STRUCTURE', '(10*2**$level)*(1-$tech_ia/100)**$usine_nani', '0', '0', '0', 'solar_station_structure.png'),
  ('CENTR_FUS', 'Centrale à fusion', 'STRUCTURE', '(120*2**$level)*(1-$tech_ia/100)**$usine_nani', '0', '0', '0', 'fusion_station_structure.png'),
  ('LASER', 'Artillerie laser', 'STRUCTURE', '10', '(100*1.05**$level)*1.03**$tech_arme', '25*1.05**$tech_bouc', '0', 'laser_artillery_structure.png'),
  ('CANON_IONS', 'Canon à ions', 'STRUCTURE', '40', '(250*1.05**$level)*1.03**$tech_arme', '200*1.05**$tech_bouc', '0', 'ion_cannon_structure.png'),
  ('BOUCLIER', 'Bouclier', 'STRUCTURE', '60*2**$level', '0', '(2000*1.3**$bouclier)*1.05**$tech_bouc', '0', 'shield_structure.png'),
  ('TECH_NRJ', 'Technologie Energie', 'RESEARCH', '4*2**$level*0.95**$labo', '0', '0', '0', 'energy_tech.png'),
  ('TECH_LASER', 'Technologie Laser', 'RESEARCH', '2*2**$level*0.95**$labo', '0', '0', '0', 'laser_artillery_structure.png'),
  ('TECH_IONS', 'Technologie Ions', 'RESEARCH', '8*2**$level*0.95**$labo', '0', '0', '0', 'ion_cannon_structure.png'),
  ('TECH_BOUC', 'Technologie Bouclier', 'RESEARCH', '5*2**$level*0.95**$labo', '0', '0', '0', 'shield_structure.png'),
  ('TECH_ARME', 'Technologie Armement', 'RESEARCH', '6*2**$level*0.95**$labo', '0', '0', '0', 'weapon_tech.png'),
  ('TECH_IA', 'Technologie Intelligence Artificielle', 'RESEARCH', '10*2**$level*0.95**$labo', '0', '0', '0', 'ia_tech.png'),
  ('CHASSEUR', 'Chasseur', 'UNIT', '20*0.95**$chantier', '75*1.03**$tech_arme', '50*1.05**$tech_bouc', '0', 'hunter_ship.png'),
  ('CROISEUR', 'Croiseur', 'UNIT', '120*0.95**$chantier', '400*1.03**$tech_arme', '150*1.05**$tech_bouc', '0', 'cruiser_ship.png'),
  ('TRANSP', 'Transporteur', 'UNIT', '55*0.95**$chantier', '0', '50*1.05**$tech_bouc', '100000', 'carrier_ship.png'),
  ('COLONIE', 'Vaisseau de colonisation', 'UNIT', '120*0.95**$chantier', '0', '50*1.05**$tech_bouc', '0', 'colonization_ship.png');
